...
void sendMessage(int create_socket) {
   ...
   char* sender = malloc(sizeof(char)*9);
   char* receiver = malloc(sizeof(char)*9);
   char* subject = malloc(sizeof(char)*81);
   char* content = malloc(sizeof(char)*BUF);
   char recvMsg[BUF];
...
void listMessage(int create_socket) {
   char* message = malloc(sizeof(char)*19);
...
void readMessage(int create_socket) {
   char* message = malloc(sizeof(char)*19);
   char* username = malloc(sizeof(char)*9);
   char* msgNumber = malloc(sizeof(char)*4);
   char recvMsg[BUF];
